...
void GLRenderer::initialize() {
    ...
    // Initialize shaders
    lightingShader = new Shader("4.4.lighting_maps.vs", "4.4.lighting_maps.fs");
    lightCubeShader = new Shader("4.4.light_cube.vs", "4.4.light_cube.fs");
    ...
    emissionMap = loadTexture(FileSystem::getPath("resources/textures/matrix.jpg").c_str());
