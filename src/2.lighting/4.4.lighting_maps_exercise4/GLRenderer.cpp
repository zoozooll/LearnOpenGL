...
GLRenderer::GLRenderer() : m_pLightingShader(nullptr), m_pLightCubeShader(nullptr), m_cubeVAO(0), m_lightCubeVAO(0), m_VBO(0), m_diffuseMap(0), m_specularMap(0), m_emissionMap(0),
...
void GLRenderer::OnInit()
{
    ...
    // ------------------------------------
    m_pLightingShader = new Shader("4.4.lighting_maps.vs", "4.4.lighting_maps.fs");
    m_pLightCubeShader = new Shader("4.4.light_cube.vs", "4.4.light_cube.fs");
    ...
    m_emissionMap = loadTexture(FileSystem::getPath("resources/textures/matrix.jpg").c_str());
