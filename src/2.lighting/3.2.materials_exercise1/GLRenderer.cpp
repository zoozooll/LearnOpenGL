...
void GLRenderer::OnInit()
{
    ...
    // ------------------------------------
    m_pLightingShader = new Shader("3.2.materials.vs", "3.2.materials.fs");
    m_pLightCubeShader = new Shader("3.2.light_cube.vs", "3.2.light_cube.fs");
...
void GLRenderer::OnDraw()
{
    ...
    if(m_pLightingShader)
    {
        ...
        // light properties
        m_pLightingShader->setVec3("light.ambient", 1.0f, 1.0f, 1.0f); // note that all light colors are set at full intensity
        m_pLightingShader->setVec3("light.diffuse", 1.0f, 1.0f, 1.0f);
        m_pLightingShader->setVec3("light.specular", 1.0f, 1.0f, 1.0f);

        // material properties
        m_pLightingShader->setVec3("material.ambient", 0.0f, 0.1f, 0.06f);
        m_pLightingShader->setVec3("material.diffuse", 0.0f, 0.50980392f, 0.50980392f);
        m_pLightingShader->setVec3("material.specular", 0.50196078f, 0.50196078f, 0.50196078f);
