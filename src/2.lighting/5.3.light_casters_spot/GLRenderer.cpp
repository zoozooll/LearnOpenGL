...
void GLRenderer::OnInit()
{
    ...
    // ------------------------------------
    m_pLightingShader = new Shader("5.3.light_casters.vs", "5.3.light_casters.fs");
    m_pLightCubeShader = new Shader("5.3.light_cube.vs", "5.3.light_cube.fs");
...
void GLRenderer::OnDraw()
{
    ...
    {
        m_pLightingShader->use();
        m_pLightingShader->setVec3("light.position", camera.Position);
        m_pLightingShader->setVec3("light.direction", camera.Front);
