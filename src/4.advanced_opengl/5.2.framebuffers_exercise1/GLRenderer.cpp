...
GLRenderer::GLRenderer(unsigned int width, unsigned int height)
    : shader(nullptr),
...
bool GLRenderer::setupGeometry()
{
    ...
    // Quad vertices - smaller quad at the top of the screen
...
bool GLRenderer::setupTextures()
{
    ...
    return cubeTexture != 0 && floorTexture != 0;
}

bool GLRenderer::setupFramebuffer()
{
