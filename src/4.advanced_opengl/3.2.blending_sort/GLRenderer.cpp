...
GLRenderer::GLRenderer() : m_pShader(nullptr), m_cubeVAO(0), m_cubeVBO(0), m_planeVAO(0), m_planeVBO(0), m_transparentVAO(0), m_transparentVBO(0),
    m_cubeTexture(0), m_floorTexture(0), m_transparentTexture(0),
...
void GLRenderer::OnInit()
{
    ...
    m_transparentTexture = loadTexture(FileSystem::getPath("resources/textures/window.png").c_str());
...
void GLRenderer::OnDraw()
{
    ...
    {
        float distance = glm::length(camera.Position - m_windows[i]);
