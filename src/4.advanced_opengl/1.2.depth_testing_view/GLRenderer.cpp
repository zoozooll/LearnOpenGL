...
GLRenderer::GLRenderer() : m_pShader(nullptr), m_cubeVAO(0), m_cubeVBO(0), m_planeVAO(0), m_planeVBO(0), m_cubeTexture(0), m_floorTexture(0),
...
void GLRenderer::OnInit()
{
    ...
    // ------------------------------------
    m_pShader = new Shader("1.2.depth_testing.vs", "1.2.depth_testing.fs");
