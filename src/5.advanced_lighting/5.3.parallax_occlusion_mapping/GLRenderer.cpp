...
void GLRenderer::OnInit()
{
    ...
    // -------------------------
    m_pShader = new Shader("5.3.parallax_mapping.vs", "5.3.parallax_mapping.fs");

    // load textures
    // -------------
    m_diffuseMap = loadTexture(FileSystem::getPath("resources/textures/bricks2.jpg").c_str());
    m_normalMap  = loadTexture(FileSystem::getPath("resources/textures/bricks2_normal.jpg").c_str());
    m_heightMap  = loadTexture(FileSystem::getPath("resources/textures/bricks2_disp.jpg").c_str());
