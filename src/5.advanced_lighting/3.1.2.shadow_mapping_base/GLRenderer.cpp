...
GLRenderer::GLRenderer() : 
    ...
    deltaTime(0.0f), lastFrame(0.0f), lightPos(-2.0f, 4.0f, -1.0f) {
...
void GLRenderer::initialize() {
    ...
    // -------------------------
    shader = new Shader("3.1.2.shadow_mapping.vs", "3.1.2.shadow_mapping.fs");
    simpleDepthShader = new Shader("3.1.2.shadow_mapping_depth.vs", "3.1.2.shadow_mapping_depth.fs");
    debugDepthQuad = new Shader("3.1.2.debug_quad.vs", "3.1.2.debug_quad_depth.fs");
