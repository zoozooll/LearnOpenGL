...
void GLRenderer::OnInit()
{
    ...
    // -------------------------
    m_pShaderGeometryPass = new Shader("8.2.g_buffer.vs", "8.2.g_buffer.fs");
    m_pShaderLightingPass = new Shader("8.2.deferred_shading.vs", "8.2.deferred_shading.fs");
    m_pShaderLightBox = new Shader("8.2.deferred_light_box.vs", "8.2.deferred_light_box.fs");
...
void GLRenderer::OnDraw()
{
    ...
    if(m_pShaderLightingPass)
    {
        ...
        for (unsigned int i = 0; i < m_lightPositions.size(); i++)
        {
            ...
            m_pShaderLightingPass->setFloat("lights[" + std::to_string(i) + "].Radius", radius);
        }
