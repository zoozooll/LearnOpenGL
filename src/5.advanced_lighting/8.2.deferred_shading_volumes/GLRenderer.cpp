...
void GLRenderer::initialize() {
    ...
    shaderGeometryPass = new Shader("8.2.g_buffer.vs", "8.2.g_buffer.fs");
    shaderLightingPass = new Shader("8.2.deferred_shading.vs", "8.2.deferred_shading.fs");
    shaderLightBox = new Shader("8.2.deferred_light_box.vs", "8.2.deferred_light_box.fs");
