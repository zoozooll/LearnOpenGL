...
void GLRenderer::initialize() {
    ...
    shader = new Shader("3.2.2.point_shadows.vs", "3.2.2.point_shadows.fs");
    simpleDepthShader = new Shader("3.2.2.point_shadows_depth.vs", "3.2.2.point_shadows_depth.fs", "3.2.2.point_shadows_depth.gs");
