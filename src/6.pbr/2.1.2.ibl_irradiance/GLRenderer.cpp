...
GLRenderer::GLRenderer() : pbrShader(nullptr), equirectangularToCubemapShader(nullptr), irradianceShader(nullptr), backgroundShader(nullptr),
    camera(glm::vec3(0.0f, 0.0f, 3.0f)), lastX(800.0f / 2.0f), lastY(600.0f / 2.0f), firstMouse(true),
    deltaTime(0.0f), lastFrame(0.0f), sphereVAO(0), indexCount(0), cubeVAO(0), cubeVBO(0),
