...
GLRenderer::GLRenderer() : deltaTime(0.0f), lastFrame(0.0f), sphereVAO(0), cubeVAO(0), indexCount(0), captureFBO(0), captureRBO(0), hdrTexture(0), envCubemap(0), irradianceMap(0) {
...
void GLRenderer::initialize() {
    ...
    pbrShader = new Shader("2.1.2.pbr.vs", "2.1.2.pbr.fs");
    equirectangularToCubemapShader = new Shader("2.1.2.cubemap.vs", "2.1.2.equirectangular_to_cubemap.fs");
    irradianceShader = new Shader("2.1.2.cubemap.vs", "2.1.2.irradiance_convolution.fs");
    backgroundShader = new Shader("2.1.2.background.vs", "2.1.2.background.fs");
    ...
    if (data)
    {
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB16F, hdrWidth, hdrHeight, 0, GL_RGB, GL_FLOAT, data); // note how we specify the texture's data value to be float
