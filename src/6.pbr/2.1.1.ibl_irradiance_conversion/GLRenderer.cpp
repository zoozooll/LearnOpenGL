...
GLRenderer::GLRenderer() : deltaTime(0.0f), lastFrame(0.0f), sphereVAO(0), cubeVAO(0), indexCount(0), captureFBO(0), captureRBO(0), hdrTexture(0), envCubemap(0) {
...
void GLRenderer::initialize() {
    ...
    pbrShader = new Shader("2.1.1.pbr.vs", "2.1.1.pbr.fs");
    equirectangularToCubemapShader = new Shader("2.1.1.cubemap.vs", "2.1.1.equirectangular_to_cubemap.fs");
    backgroundShader = new Shader("2.1.1.background.vs", "2.1.1.background.fs");
