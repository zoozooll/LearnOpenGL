...
GLRenderer::GLRenderer() : m_pShader(nullptr), VBO(0), VAO(0), texture1(0), texture2(0),
    camera(glm::vec3(0.0f, 0.0f, 3.0f)), lastX(800.0f / 2.0f), lastY(600.0f / 2.0f), firstMouse(true),
    deltaTime(0.0f), lastFrame(0.0f), m_width(800), m_height(600)
{
}
...
void GLRenderer::OnInit()
{
    ...
    // ------------------------------------
    m_pShader = new Shader("7.4.camera.vs", "7.4.camera.fs");
